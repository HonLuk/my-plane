...
Commands for managing modules in projects.
"""
...
def cmd_modules_list(args):
    """List modules in a project with pagination support."""
    _validate_id(args.project, "project ID")
    endpoint = f"/workspaces/{get_workspace()}/projects/{args.project}/modules/"
    params = {}
...
def cmd_modules_get(args):
    ...
    data = api("GET", f"/workspaces/{get_workspace()}/projects/{args.project}/modules/{args.module}/")
    format_output(data, args.format)
...
def cmd_modules_create(args):
    ...
    data = api("POST", f"/workspaces/{get_workspace()}/projects/{args.project}/modules/", payload)
